...
Además, Thomas tiene un par de video en Youtube en donde habla sobre esta librería, cómo entender la lógica que usa (de capas) y explica varios ejemplos. Puedes ver la [parte 1](https://youtu.be/h29g21z0a68) y la [parte 2](https://youtu.be/0m4yywqNPVY). También puedes visitar [su GitHub](https://github.com/thomasp85/ggplot2_workshop) en donde tiene los scripts y ejercicios mostrados en los videos.
