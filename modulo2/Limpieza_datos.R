...
#author: "Macarena Valenzuela Beltrán-Rladies Concepciónn"
...
#juntamos las columnas century y year en una nueva columna llamada new_year y omitimos el símbolo (_) creados entre los valores
